...
public class RevisedDocument extends Configured implements Tool {

	public static void main(String[] args) throws Exception {
		System.out.println(Arrays.toString(args));
		Configuration conf = new Configuration();

		int res = ToolRunner.run(conf, new RevisedDocument(),
				args);
	...
	public int run(String[] args) throws Exception {
		...
		Job job = new Job(getConf(), "RevisedDocument");
		job.setJarByClass(RevisedDocument.class);
